...
function CommentDetailPage({ params }) {
  ...
  const comment = {
    id: params.id,
    content:
      "I had excellent service from Green Reality. Thank you very much for your very pro-active help and support in achieving our purchase our apartment. Best regard and hope to work with you again very soon.",
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-center space-x-4 pt-6">
            ...
            <Button
              ...
              className="bg-[#521282] hover:bg-purple-700 text-white px-8 py-2"
            >
              Approve
            </Button>
          </div>
