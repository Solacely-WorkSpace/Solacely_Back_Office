      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="space-y-4">
              {listings.length === 0 ? (
                <p className="text-center py-8 text-gray-500">No listings found</p>
              ) : (
                  ...
                  <div key={listing.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 truncate max-w-[200px]">{listing.address}</p>
                        <div className="flex items-center space-x-2 mt-1">
                          ...
                          <span className="text-xs text-gray-500">
                            {listing.bedroom} bed • {listing.bathroom} bath • {listing.area} sqft
                          </span>
                        </div>
                      </div>
                    </div>
                    <div className="flex space-x-2">
                      ...
                      >
                        <Badge variant={listing.active ? "destructive" : "success"}>
